...
def apply() -> bool:
    ...
    if hasattr(q35.TextModel, "mtp_forward") and not hasattr(
        q35.TextModel, "_fusion_mlx_mtp_patched"
    ):
        q35.TextModel._fusion_mlx_mtp_patched = "upstream"
        return True
    ...
    if not hasattr(q35.TextModel, "_fusion_mlx_mtp_patched"):
        q35.TextModel._fusion_mlx_mtp_patched = "patch"
...
def _patch_text_model_args(q35: Any) -> None:
    ...
    if hasattr(args_cls, "_fusion_mlx_mtp_from_dict_patched"):
        return
    ...
    args_cls._fusion_mlx_mtp_from_dict_patched = True
...
def _patch_gated_delta_net(q35: Any) -> None:
    ...
    if _is_our_method(cls, "__call__", "_fusion_mlx_mtp_call_marker"):
        return
    ...
    __call__._fusion_mlx_mtp_call_marker = True
...
def _patch_text_model(q35: Any) -> None:
    ...
    call_owned = _is_our_method(cls, "__call__", "_fusion_mlx_mtp_call_marker")
    ...
    def __init__(self, args):
        ...
        self._fusion_mlx_mtp_decode_enabled = mtp_decode_enabled
    ...
    def sanitize(self, weights):
        ...
        if not hasattr(self, "mtp"):
            ...
            raise ValueError(
                ...
                "open the model's settings in the FusionMLX admin UI and toggle "
    ...
    if not init_wrapped:
        ...
        cls._fusion_mlx_mtp_init_wrapped = True
    __call__._fusion_mlx_mtp_call_marker = True
    cls.__call__ = __call__
...
def _patch_outer_model(q35: Any) -> None:
    ...
    # function-level _fusion_mlx_mtp_call_marker above.
    cls._fusion_mlx_mtp_patched = True
...
def _patch_qwen3_5_moe() -> None:
    ...
    cls = moe.Model
    if _is_our_method(cls, "sanitize", "_fusion_mlx_mtp_call_marker"):
        return
    ...
    sanitize._fusion_mlx_mtp_call_marker = True
    cls.sanitize = sanitize

...
This module wraps each dflash hook installer so FusionMLX can:
...
def _wrap_installer(mod: Any, fn_name: str, flag_name: str) -> bool:
    ...
    """
    if getattr(mod, "_fusion_mlx_wrapped_" + fn_name, False):
        return True
    ...
    setattr(mod, "_fusion_mlx_wrapped_" + fn_name, True)
    return True

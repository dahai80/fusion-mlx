...
def apply() -> bool:
    ...
    cls = q35moevlm.Model
    if cls.__dict__.get("_fusion_mlx_mtp_vlm_patched", False):
        _APPLIED = True
        return True
    ...
    def sanitize(self, weights):
        ...
        for key, value in weights.items():
            ...
            if "conv1d.weight" in key and value.shape[-1] != 1:
                ...
                # monkey-patch in fusion_mlx.oq when called with _TrackedTensor;
    ...
    cls._fusion_mlx_mtp_vlm_patched = True
    _APPLIED = True

...
def _patch_skip_multimodal_module(vlm_utils: Any) -> None:
    ...
    if original is None or getattr(original, "_fusion_mlx_minimax_m3_compat", False):
        return

    def patched_skip_multimodal_module(path: str) -> bool:
        return "patch_merge_mlp" in path or original(path)

    patched_skip_multimodal_module._fusion_mlx_minimax_m3_compat = True
    patched_skip_multimodal_module._fusion_mlx_original = original
...
def _patch_get_model_and_args(vlm_utils: Any) -> None:
    ...
    patched_get_model_and_args._fusion_mlx_minimax_m3_compat = True
    patched_get_model_and_args._fusion_mlx_original = original
...
def _patch_process_inputs(vlm_utils: Any) -> None:
    ...
    patched_process_inputs._fusion_mlx_minimax_m3_compat = True
    patched_process_inputs._fusion_mlx_original = original
...
def _patch_stopping_criteria(vlm_utils: Any) -> None:
    ...
    PatchedStoppingCriteria._fusion_mlx_minimax_m3_compat = True
    PatchedStoppingCriteria._fusion_mlx_original = original_cls
...
def _patch_load_config_and_model(vlm_utils: Any) -> None:
    ...
    if original_load_config is not None and not getattr(
        original_load_config, "_fusion_mlx_minimax_m3_compat", False
    ):
        ...
        patched_load_config._fusion_mlx_minimax_m3_compat = True
        patched_load_config._fusion_mlx_original = original_load_config
    ...
    if original_load_model is None or getattr(
        original_load_model, "_fusion_mlx_minimax_m3_compat", False
    ):
        return
    ...
    patched_load_model._fusion_mlx_minimax_m3_compat = True
    patched_load_model._fusion_mlx_original = original_load_model
...
def _patch_nn_quantize_for_ignored_layers() -> None:
    ...
    if getattr(original, "_fusion_mlx_minimax_m3_compat", False):
        return
    ...
    patched_quantize._fusion_mlx_minimax_m3_compat = True
    patched_quantize._fusion_mlx_original = original
...
def _patch_prompt_utils(prompt_utils: Any) -> None:
    ...
    if original_get_message_json is not None and not getattr(
        original_get_message_json, "_fusion_mlx_minimax_m3_compat", False
    ):
        ...
        patched_get_message_json._fusion_mlx_minimax_m3_compat = True
        patched_get_message_json._fusion_mlx_original = original_get_message_json
    ...
    if original_apply_chat_template is None or getattr(
        original_apply_chat_template, "_fusion_mlx_minimax_m3_compat", False
    ):
        return
    ...
    patched_apply_chat_template._fusion_mlx_minimax_m3_compat = True
    patched_apply_chat_template._fusion_mlx_original = original_apply_chat_template

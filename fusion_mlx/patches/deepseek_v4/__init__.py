...
Brings PR 1192 (https://github.com/ml-explore/mlx-lm/pull/1192) into fusion_mlx
...
6. Registers fusion_mlx-side cache handlers for the two new cache classes so
...
def _register_module(qualname: str, file_name: str) -> None:
    ...
    the real mlx_lm package — *not* through fusion_mlx.
...
def _register_cache_handlers() -> None:
    """Register PoolingCache / BatchPoolingCache handlers in fusion_mlx CacheTypeRegistry."""
...
def apply_deepseek_v4_patch() -> bool:
    ...
    # 8. Register fusion_mlx-side cache handlers.

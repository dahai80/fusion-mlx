...
from fusion_mlx.cache.type_handlers import (
    CacheStateAxisInfo,
    CacheType,
    CacheTypeHandler,
)
...
class PoolingCacheHandler(CacheTypeHandler):
    ...
    def get_state_axis_info(self) -> tuple[CacheStateAxisInfo, ...]:
        ...
        # all three elements non-sliceable so fusion_mlx core takes the
    ...
    def deserialize_state(
        ...
        fusion_mlx core dispatches handlers via ``deserialize_state`` instead of

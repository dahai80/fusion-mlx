...
fusion_mlx registers this module as ``mlx_lm.chat_templates.deepseek_v4`` so
...
def encode_arguments_to_dsml(tool_call: Dict[str, str]) -> str:
    ...
    # OpenAI tool_calls store arguments as a JSON string; the fusion_mlx
...
def apply_chat_template(
    ...
    # mlx-lm and the fusion_mlx server forward an ``enable_thinking`` boolean

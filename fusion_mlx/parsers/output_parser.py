...
request is generating (e.g. Harmony channel parsing, MiniMax M3 protocol
normalization, or Cohere2 MoE Melody output) and exposes a uniform
token-by-token interface.
"""
...
_MINIMAX_TOOL_CALL_START = "]<]minimax[>["
_MINIMAX_TOOL_CALL_END = "]<]minimax[>]"

...
"""HuggingFace model uploader for Fusion-MLX admin panel.
...
This model was quantized using [oQ](https://github.com/dahai80/fusion-mlx) (Fusion-MLX v{__version__}) mixed-precision quantization.
        ...
        try:
            async with self._upload_sem:
                ...
                await asyncio.to_thread(
                    ...
                    repo_id=task.repo_id,
                    token=token,
                    commit_message=f"Upload {task.model_name} via Fusion-MLX",
                )

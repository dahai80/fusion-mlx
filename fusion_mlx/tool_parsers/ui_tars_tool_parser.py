...
"""UI-TARS Computer-Use action parser for fusion-mlx.
...
The accompanying reasoning parser (``fusion_mlx.reasoning.ui_tars_parser``)
...
def _generate_tool_id() -> str:
    ...
    Adapter layer (``fusion_mlx/api/anthropic_adapter.py``) rewrites the

...
"""
MCP (Model Context Protocol) client support for fusion-mlx.

This module provides integration with MCP servers, allowing the fusion-mlx server
to discover and execute tools from external MCP servers.

Example usage:
    from fusion_mlx.mcp import MCPClientManager, load_mcp_config

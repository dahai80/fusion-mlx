...
# Pure-MLX port of LTX-2 conditioning (vendored from mlx-video).
# Phase 4 LTX-2 direct-MLX port: latent-based I2V conditioning.
import logging
...
def apply_conditioning(
    ...
    for cond in conditionings:
        ...
        logger.debug(
            "apply_conditioning: frame_idx=%d end_idx=%d strength=%s",
            frame_idx,
            end_idx,
            strength,
        )

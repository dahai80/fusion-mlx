...
in ``fusion_mlx/_sampler_fast_path.py`` likewise calls
...
versions or backends"). Two calls to fusion-mlx with the same
...
def make_seeded_sampler(
    *,
    ...
    #     reproducibility is preserved within fusion-mlx. (OpenAI's spec

...
def patch_qwen3_vl_processor_for_torch_free_image_loading() -> None:
    ...
    class TorchFreeQwen3VLAutoImageProcessor:
        _original_auto_image_processor = original_auto_image_processor
    ...
    if (
        ...
        and not getattr(original_build_processor, "_patched", False)
    ):
        ...
        build_processor_with_mm_token_ids._patched = True

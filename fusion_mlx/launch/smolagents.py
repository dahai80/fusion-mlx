...
"""smolagents launch adapter — writes ~/.smolagents/config.json."""
...
_CONFIG_PATH = Path.home() / ".smolagents" / "config.json"


def detect() -> bool:
    return _common.which("smolagents") is not None or _CONFIG_PATH.exists()

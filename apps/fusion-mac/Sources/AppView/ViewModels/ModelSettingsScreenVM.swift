...
final class ModelSettingsScreenVM {
    ...
    func load(modelID: String, client: FusionClient) async {
    ...
    func save(_ field: Field, client: FusionClient) async {
    ...
    /// server templates.
    func applyChip(scope: ProfileScope, name: String, client: FusionClient) async {
        do {
            switch scope {
            case .preset:
    ...
    func renameTemplate(from original: String, to renamed: String, client: FusionClient) async {
        do {
    ...
    func renameModelProfile(from original: String, to renamed: String, client: FusionClient) async {
        do {
    ...
    func setExposeAsModel(name: String, exposed: Bool, client: FusionClient) async {
        do {
            _ = try await client.updateModelProfile(
                id: modelID,
                name: name,
    ...
    /// first apply.
    func applyPreset(_ entry: PresetEntry, client: FusionClient) async {
        do {
    ...
    func saveWorkingAs(scope: ProfileScope, name: String, client: FusionClient) async {
    ...
    func updateProfileWithWorking(scope: ProfileScope, name: String, client: FusionClient) async {
    ...
    func revertWorking(client: FusionClient) async {
        await load(modelID: modelID, client: client)
    }
    ...
    func applyProfile(name: String, client: FusionClient) async {
        do {
            _ = try await client.applyModelProfile(id: modelID, name: name)
            await load(modelID: modelID, client: client)
        } catch {
    ...
    func createProfile(name: String, client: FusionClient) async {
        do {
            _ = try await client.createModelProfile(
                id: modelID,
                body: CreateProfileRequest(
    ...
    func deleteProfile(name: String, client: FusionClient) async {
    ...
    func applyTemplate(template: ProfileDTO, client: FusionClient) async {
        do {
            _ = try await client.createModelProfile(
                id: modelID,
                body: CreateProfileRequest(

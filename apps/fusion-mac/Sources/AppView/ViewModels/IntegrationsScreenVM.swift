...
final class IntegrationsScreenVM {
    ...
    /// Composed `fusion launch claude` command. Claude tier selections are
    ...
    /// vars, local form sets them to point at the FusionMLX server.
    ...
    private var cliCommandPrefix: String {
        cliPrefix == "fusion" ? cliPrefix : Self.shellQuote(cliPrefix)
    }

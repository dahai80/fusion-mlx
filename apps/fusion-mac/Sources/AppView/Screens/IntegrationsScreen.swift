...
// Claude Code setup command — both the simple `fusion launch claude` form and
...
/// Houses both the primary `fusion launch claude` block and the "Advanced"
/// env-var recipe that points the real `claude` binary at the local server.
/// Mirrors `claudeCodeCommand` in `fusion/admin/static/js/dashboard.js`.
                ...
                VStack(alignment: .leading, spacing: 6) {
                    Text(vm.claudeMode == "cloud"
                         ...
                         : String(localized: "integrations.setup.advanced.local",
                                  defaultValue: "Points the real `claude` binary at your local FusionMLX server.",

...
// (fusion/admin/templates/dashboard/_models.html:1025-1280 + dashboard.js:3437-
...
//                            "app.fusion-mlx.hf-upload"); never persisted to
...
private struct StatusChip: View {
    ...
    var body: some View {
        ...
        Text(cfg.1)
            .font(.fusionText(10, weight: .semibold))
    ...
    private var footer: some View {
        HStack(spacing: 8) {
            ...
            Button(String(localized: "common.cancel",
                ...
                .buttonStyle(.fusion(.normal, size: .regular))
            ...
            FreeRow(isLast: true) {
                VStack(alignment: .leading, spacing: 10) {
                    Text(String(localized: "quant.about.headline",
                                defaultValue: "FusionMLX Universal Dynamic Quantization",
                                comment: "Headline inside the About oQ card"))
                        .font(.fusionText(13, weight: .semibold))
                        .foregroundStyle(theme.text)
                    Text(String(localized: "quant.about.body1",
                                defaultValue: "Quantization should not be exclusive to any particular inference server. oQ produces standard mlx-lm models that work everywhere — FusionMLX, mlx-lm, LM Studio, and any app that supports MLX safetensors format. No custom loader required.",
...
enum Keychain {
    private static let service = "app.fusion-mlx.hf-upload"

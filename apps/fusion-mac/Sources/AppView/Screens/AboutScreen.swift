...
private struct HeroCard: View {
    ...
    var body: some View {
        HStack(spacing: 16) {
            ...
            // fusion mark as the Dock icon and README hero, light/dark
            ...
            VStack(alignment: .leading, spacing: 4) {
                Text("FusionMLX")
                    .font(.fusionText(22, weight: .semibold))
                    .foregroundStyle(theme.text)
                Text(String(localized: "about.hero.tagline",
                            defaultValue: "Local AI, no more waiting on your Mac.",
                            comment: "Tagline shown under the FusionMLX product name on the About screen hero card"))
                    .font(.fusionText(12))
        ...
        ListGroup {
            LinkRow(
                label: String(localized: "about.project.github.label",
                              ...
                              comment: "About screen link row label pointing to the FusionMLX GitHub repo"),
            ...
            FreeRow(isLast: true) {
                VStack(alignment: .leading, spacing: 6) {
                    ...
                    Text(String(localized: "about.license.notice",
                                defaultValue: "Copyright © FusionMLX contributors. Licensed under the Apache License, Version 2.0. See the LICENSE file in the repository for the full text.",

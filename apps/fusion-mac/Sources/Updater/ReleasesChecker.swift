...
enum ReleasesChecker {
    static let releasesURL = URL(string: "https://api.github.com/repos/dahai80/fusion-mlx/releases?per_page=20")!
    ...
    /// PEP 440-style prerelease ordering for FusionMLX tags:

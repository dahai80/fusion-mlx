...
//
// PR 7's FusionClient will absorb this auth machinery; for now the poller owns
...
final class MenubarStatsPoller {
    static let didUpdateNotification = Notification.Name("FusionMenubarStatsDidUpdate")
    ...
    init(baseURL: URL, apiKey: String?, interval: TimeInterval = 2.0) {
        ...
        // jar — matches FusionClient and inherits its login session.

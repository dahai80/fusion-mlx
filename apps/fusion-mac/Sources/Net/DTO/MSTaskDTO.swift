...
//
// The server's MS downloader (`fusion/admin/ms_downloader.py:19`) imports
...
// `MSDownloadRequest` (fusion/admin/routes.py:287-291) uses `model_id` /
...
/// flag in `fusion/server.py:1278`). The Downloads tab gates the MS branch

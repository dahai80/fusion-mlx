...
//
// Throughput mirrors fusion/admin/routes.py:/api/bench/* (start @4619,
...
///
/// The server always publishes results to the public fusion.ai
...
struct BenchResultsResponse: Codable, Sendable {
    ...
    /// (fusion/admin/benchmark.py:_upload_to_fusion_ai). Populated server-side

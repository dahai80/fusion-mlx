...
// PR 7 screens. Kept separate from `FusionClient.swift` so PR 8/9 can grow this
// file without churning the client itself.
//
// The actual `getX()` methods live as extensions on `FusionClient` (see
// `FusionClient.swift`). This file is the canonical list of paths so future
...
enum AdminAPI {
    ...
    /// Proxy that fetches the remote preset bundle from fusion.ai and returns

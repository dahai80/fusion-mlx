...
final class AppServicesPathTests: XCTestCase {
    ...
    func testRelocateOutsideTreeIsUnchanged() {
        XCTAssertEqual(
            AppServices.relocate(path: "/Volumes/SSD/models",
                                 oldBase: "/Users/Fido/.fusion",
                                 newBase: "/Users/Fido/.fusion-other"),
            "/Volumes/SSD/models"
        )
    }
    ...
    func testRelocateTildeIsExpanded() {
        ...
        XCTAssertEqual(
            AppServices.relocate(path: "~/.fusion/models",
                                 oldBase: "\(home)/.fusion",
                                 newBase: "\(home)/.fusion-other"),
            "\(home)/.fusion-other/models"
        )
    }
    ...
    private func makeTempSettingsFile(contents: [String: Any]) throws -> URL {
        let dir = FileManager.default.temporaryDirectory
            .appendingPathComponent("FusionMLXTests-\(UUID().uuidString)")
    ...
    func testRelocateOrphanPathsHappyPath() throws {
        let url = try makeTempSettingsFile(contents: [
            "model": [
                "model_dirs": ["/Users/Fido/.fusion-other/models"],
                "model_dir": "/Users/Fido/.fusion-other/models",
                "max_model_memory": "auto"
            ],
            "cache": [
                "ssd_cache_dir": "/Users/Fido/.fusion-other/cache",
                "enabled": true
            ],
            "logging": [
                "log_dir": "/Users/Fido/.fusion-other/logs",
                "retention_days": 7
            ],
        ...
        try AppServices.relocateOrphanPaths(
            in: url,
            oldBase: "/Users/Fido/.fusion-other",
            newBase: "/Users/Fido/.fusion"
        )

        let after = try readJSON(url)
        let model = after["model"] as! [String: Any]
        XCTAssertEqual(model["model_dirs"] as! [String], ["/Users/Fido/.fusion/models"])
        XCTAssertEqual(model["model_dir"] as! String, "/Users/Fido/.fusion/models")
        ...
        XCTAssertEqual(cache["ssd_cache_dir"] as! String, "/Users/Fido/.fusion/cache")
        XCTAssertEqual(cache["enabled"] as! Bool, true)

        let logging = after["logging"] as! [String: Any]
        XCTAssertEqual(logging["log_dir"] as! String, "/Users/Fido/.fusion/logs")

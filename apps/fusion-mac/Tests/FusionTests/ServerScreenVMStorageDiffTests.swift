...
final class ServerScreenVMStorageDiffTests: XCTestCase {
    ...
    func testNoChanges() {
        let services = makeServices(basePath: "/Users/Fido/.fusion",
                                    modelDir: "/Users/Fido/.fusion/models")
        let vm = ServerScreenVM()
        vm.basePathText = "/Users/Fido/.fusion"
        vm.modelDirTexts = ["/Users/Fido/.fusion/models"]
    ...
    func testBaseChangedOnly() {
        let services = makeServices(basePath: "/Users/Fido/.fusion",
                                    modelDir: "/Users/Fido/.fusion/models")
        let vm = ServerScreenVM()
        vm.basePathText = "/Users/Fido/.fusion-other"
        vm.modelDirTexts = ["/Users/Fido/.fusion/models"]

        let diff = vm.storageDiff(services: services)
        XCTAssertTrue(diff.baseChanged)
        XCTAssertFalse(diff.modelDirsChanged)
        XCTAssertEqual(diff.normalizedBase, "/Users/Fido/.fusion-other")
    }
    ...
    func testTildeExpansion() {
        ...
        let services = makeServices(basePath: "\(home)/.fusion",
                                    modelDir: "\(home)/.fusion/models")
        let vm = ServerScreenVM()
        vm.basePathText = "~/.fusion"
        vm.modelDirTexts = ["~/.fusion/models"]
    ...
    func testMultipleModelDirsNormalizeToNoDiff() {
        let services = makeServices(
            basePath: "/Users/Fido/.fusion",
            modelDirs: ["/Users/Fido/.fusion/models", "/Volumes/SSD/models"]
        )
        let vm = ServerScreenVM()
        vm.basePathText = "/Users/Fido/.fusion"
        vm.modelDirTexts = [
    ...
    func testModelDirReorderTriggersChange() {
        ...
        let vm = ServerScreenVM()
        vm.basePathText = "/Users/Fido/.fusion"
        vm.modelDirTexts = ["/Volumes/SSD/models", "/Users/Fido/.fusion/models"]
    ...
    func testApplyConfigKeepsWildcardBindButUsesLoopbackEndpoint() {
        let cfg = AppConfig(
            ...
            basePath: "/Users/Fido/.fusion",
            modelDir: "/Users/Fido/.fusion/models",
            modelDirs: ["/Users/Fido/.fusion/models"],
            hfEndpoint: ""
        )
        let vm = ServerScreenVM()

...
# Migrated from Rapid-MLX test_chat_template_tool_call_arguments.py
# vllm_mlx.utils.chat_template -> fusion_mlx.utils.chat_template (stub)
...
def _require_chat_template():
    if not _HAS_CHAT_TEMPLATE:
        pytest.skip("fusion_mlx.utils.chat_template helpers not migrated yet")


@pytest.fixture(autouse=True)
def _guard_chat_template():
    _require_chat_template()

...
from fusion_mlx.api.utils import sanitize_output, strip_reasoning_channel_markup
...
class TestThinkLiteralLeak:
    ...
    def test_max_tokens_1_no_think_leak_in_any_block(self, monkeypatch):
        ...
        monkeypatch.setenv("FUSION_REASONING_RESCUE", "on")

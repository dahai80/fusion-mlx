...
def test_is_apple_silicon():
    ...
    from fusion_mlx.plugin import is_mlx_available
...
def test_mlx_platform_properties():
    ...
    from fusion_mlx.vllm_platform import MLXPlatform
...
def test_plugin_entry_point():
    ...
    from fusion_mlx.plugin import mlx_platform_plugin
...
def test_device_info():
    ...
    from fusion_mlx.plugin import get_mlx_device_info

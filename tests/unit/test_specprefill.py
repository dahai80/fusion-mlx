...
class TestSelectChunks:
    ...
    def test_basic_selection(self):
        from fusion_mlx.patches.specprefill import select_chunks
...
class TestManualRoPE:
    ...
    def test_contiguous_matches_standard(self):
        from fusion_mlx.patches.specprefill import manual_rope
...
class TestAvgPool1d:
    ...
    def test_identity_kernel_1(self):
        from fusion_mlx.patches.specprefill import _avg_pool1d
...
class TestKeepRatePresets:
    ...
    def test_presets_exist(self):
        from fusion_mlx.patches.specprefill import (
            DEFAULT_KEEP_RATE,
            DEFAULT_THRESHOLD,
            KEEP_RATE_PRESETS,
        )
...
class TestModelTopologyHelpers:
    ...
    def test_find_attention_layers_empty(self):
        ...
        from fusion_mlx.patches.specprefill import _find_attention_layers
    ...
    def test_get_attn_module_self_attn(self):
        ...
        from fusion_mlx.patches.specprefill import _get_attn_module
    ...
    def test_attention_capture_forwards_extra_kwargs(self):
        ...
        from fusion_mlx.patches.specprefill import _AttentionCapture
    ...
    def test_gemma4_extract_queries_applies_q_norm(self):
        ...
        from fusion_mlx.patches.specprefill import _gemma4_extract_queries
    ...
    def test_qwen36_extract_queries_applies_q_norm(self):
        ...
        from fusion_mlx.patches.specprefill import _qwen36_extract_queries
    ...
    def test_llama_extract_queries_without_q_norm(self):
        ...
        from fusion_mlx.patches.specprefill import _llama_extract_queries
    ...
    def test_build_layer_to_cache_map_gemma_shared_kv_vlm(self):
        ...
        from fusion_mlx.patches.specprefill import _build_layer_to_cache_map
...
class TestRoPEWrappers:
    ...
    def test_position_mapped_rope_accepts_mx_array_offset(self):
        ...
        from fusion_mlx.patches.specprefill import _PositionMappedRoPE
    ...
    def test_offset_adjusted_rope_adds_offset(self):
        from fusion_mlx.patches.specprefill import _OffsetAdjustedRoPE

...
class TestBatchGeneratorClose:
    ...
    @pytest.mark.skip(
        reason="fusion-mlx Scheduler has no _close_batch_generator method"
    )
    ...
    @pytest.mark.skip(
        reason="fusion-mlx reset() does not call batch_generator.close() in same way as Rapid-MLX"
    )
    ...
    @pytest.mark.skip(
        reason="fusion-mlx _recover_from_cache_error does not call batch_generator.close() in same way"
    )
    ...
    @pytest.mark.skip(
        reason="fusion-mlx Scheduler has no _close_batch_generator / _current_sampler_params"
    )
...
class TestClearCacheInterval:
    ...
    @pytest.mark.skip(
        reason="fusion-mlx Scheduler uses _step_counter, not _step_count/_clear_cache_interval"
    )
    ...
    @pytest.mark.skip(
        reason="fusion-mlx periodic cache clearing uses different mechanism"
    )
    def test_clear_cache_called_periodically(self):
        pass

    @pytest.mark.skip(
        reason="fusion-mlx _cleanup_finished signature differs from Rapid-MLX"
    )
...
class TestIncrementalCacheEval:
    ...
    @pytest.mark.skip(
        reason="fusion-mlx _cleanup_finished signature and behavior differ from Rapid-MLX"
    )
    ...
    @pytest.mark.skip(
        reason="fusion-mlx _process_batch_responses behavior differs from Rapid-MLX"
    )
...
class TestMemoryStats:
    ...
    @pytest.mark.skip(
        reason="get_stats() Metal memory stats come from mllm_scheduler, not base Scheduler"
    )

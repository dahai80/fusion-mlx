...
Let's begin the session. I'm ready to help with any technical questions you have."""
    ...
    from fusion_mlx.prefix_cache import PrefixCacheManager
    ...
    print("\n--- Test WITH Paged Cache ---")
    from fusion_mlx.paged_cache import PagedCacheManager
    from fusion_mlx.prefix_cache import BlockAwarePrefixCache

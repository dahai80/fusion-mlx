...
from fusion_mlx.api.openai_models import StructuredOutputOptions
...
class TestNormalizeStructuredOutputs:
    ...
    def test_guided_grammar_becomes_structured_outputs_grammar(self):
        from fusion_mlx.server import _normalize_structured_outputs
...
class TestSettingsGuidedGrammar:
    ...
    def test_disabled_setting_returns_none(self):
        from fusion_mlx.server import _settings_guided_grammar

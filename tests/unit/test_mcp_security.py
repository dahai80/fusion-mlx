...
from fusion_mlx.mcp.security import (
    ALLOWED_COMMANDS,
    MCPCommandValidator,
    MCPSecurityError,
    ToolExecutionAudit,
...
from fusion_mlx.mcp.types import MCPServerConfig, MCPTransport
...
class TestConfigDiscoveryNoCWD:
    ...
    def test_cwd_mcp_json_not_auto_discovered(self, tmp_path, monkeypatch):
        from fusion_mlx.mcp.config import CONFIG_SEARCH_PATHS, load_mcp_config
    ...
    def test_explicit_path_still_works(self, tmp_path):
        ...
        from fusion_mlx.mcp.config import load_mcp_config
...
class TestAllowedHighRiskToolsConfig:
    ...
    def test_default_empty(self):
        from fusion_mlx.mcp.types import MCPConfig
    ...
    def test_validate_config_rejects_non_list(self):
        from fusion_mlx.mcp.config import validate_config

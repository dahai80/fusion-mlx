...
class TestMLLMBatchRequest:
    ...
    def test_create_request(self):
        ...
        from fusion_mlx.mllm_batch_generator import MLLMBatchRequest
...
class TestMLLMBatchResponse:
    ...
    def test_create_response(self):
        ...
        from fusion_mlx.mllm_batch_generator import MLLMBatchResponse
...
class TestMLLMBatch:
    ...
    def test_batch_length(self):
        ...
        from fusion_mlx.mllm_batch_generator import MLLMBatch, MLLMBatchRequest
...
class TestMLLMBatchStats:
    ...
    def test_stats_initialization(self):
        ...
        from fusion_mlx.mllm_batch_generator import MLLMBatchStats
...
class TestMLLMSchedulerOutput:
    ...
    def test_empty_output(self):
        ...
        from fusion_mlx.mllm_scheduler import MLLMSchedulerOutput
...
class TestMultimodalProcessorBatch:
    ...
    def test_batch_pixel_values_empty(self):
        ...
        from fusion_mlx.multimodal_processor import MultimodalProcessor
    ...
    def test_prepare_for_batch(self):
        ...
        from fusion_mlx.multimodal_processor import (
            MultimodalProcessor,
...
class TestVisionCache:
    ...
    def test_cache_creation(self):
        ...
        from fusion_mlx.mllm_cache import MLLMCacheManager
...
class TestVisionEmbeddingCacheHash:
    ...
    def test_image_order_produces_different_hashes(self):
        ...
        from fusion_mlx.vision_embedding_cache import compute_images_hash
    ...
    def test_full_file_hash_no_64kb_collision(self):
        ...
        from fusion_mlx.vision_embedding_cache import compute_image_hash
...
class TestMLLMSchedulerStopSequences:
    ...
    def test_empty_stop_string_uses_normal_text_accumulation(self):
        ...
        """
        from fusion_mlx.mllm_batch_generator import MLLMBatchResponse
        from fusion_mlx.mllm_scheduler import (
            MLLMRequest,
            MLLMScheduler,
            MLLMSchedulerConfig,
        )

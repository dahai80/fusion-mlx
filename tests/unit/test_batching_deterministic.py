...
def mlx_executor():
    ...
    from fusion_mlx.engine_core import _init_mlx_step_thread
...
def sampling_params():
    ...
    from fusion_mlx import SamplingParams
...
class TestDeterministicSingleRequest:
    ...
    async def test_same_prompt_same_output(
        ...
        from fusion_mlx import AsyncEngineCore, EngineConfig, SchedulerConfig
    ...
    async def test_token_streaming_order(
        ...
        from fusion_mlx import AsyncEngineCore
...
class TestRequestManagement:
    ...
    async def test_abort_request(self, model_and_tokenizer, mlx_executor):
        ...
        from fusion_mlx import AsyncEngineCore, SamplingParams
...
class TestSchedulerPolicy:
    ...
    async def test_fcfs_ordering(self, model_and_tokenizer, mlx_executor):
        ...
        from fusion_mlx.scheduler import SchedulingPolicy

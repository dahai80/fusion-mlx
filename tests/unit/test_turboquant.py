...
def test_attention_patch_routes_tq():
    from fusion_mlx.patches.turboquant_attention import apply_turboquant_attention_patch
...
def test_attention_patch_routes_long_tq_prefill_to_quantized_attention(monkeypatch):
    ...
    from fusion_mlx.patches import turboquant_attention as tq_attention
...
def test_from_cache_merge_builds_working_batch():
    ...
    """
    import fusion_mlx.scheduler  # noqa: F401  (applies the merge monkey-patch)

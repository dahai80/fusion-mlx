...
from fusion_mlx.engines.reranker import MLXRerankerModel, RerankOutput
...
class TestCausalLMReranker:
    ...
    def test_rerank_causal_lm_scoring(self, tmp_path):
        ...
        model._processor = mock_tokenizer
        ...
        model._model = MagicMock(side_effect=mock_forward)
...
class TestJinaReranker:
    ...
    def test_get_jina_hidden_states_accepts_3d_tensor(self):
        ...
        model._model.model = MagicMock(return_value=expected)
    ...
    def test_get_jina_hidden_states_expands_2d_tensor(self):
        ...
        model._model = MagicMock()
        model._model.model = MagicMock(return_value=returned)
    ...
    def test_get_jina_hidden_states_rejects_unsupported_output(self):
        ...
        model._model = MagicMock()
        model._model.model = MagicMock(return_value=_UnsupportedOutput())
    ...
    def test_get_jina_hidden_states_rejects_invalid_tensor_rank(self):
        ...
        model._model = MagicMock()
        model._model.model = MagicMock(return_value=invalid)
        input_ids = mx.array([[1, 2, 3, 4]])

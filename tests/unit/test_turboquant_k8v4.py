...
Adapted from Rapid-MLX. K8V4-specific symbols (TurboQuantConfig,
...
pytestmark = pytest.mark.skipif(
    not _HAS_TQ,
    reason="missing-feature: fusion_mlx.turboquant_kv not available",
)
...
@pytest.mark.skip(reason="missing-feature: CLI turboquant flags not in fusion-mlx")
class TestCLIFlag:
    pass


@pytest.mark.skip(reason="missing-feature: routes.metrics not in fusion-mlx")
class TestMetrics:
    pass

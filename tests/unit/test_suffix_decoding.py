...
from fusion_mlx.speculative.suffix_decoding import (
    DraftStats,
...
class TestInstallSuffixDecoding:
    ...
    def test_hybrid_profile_skips_install(self):
        ...
        from fusion_mlx.scheduler import _install_suffix_decoding
    ...
    def test_drafter_pruned_when_primary_finishes(self):
        ...
        from fusion_mlx.scheduler import _install_suffix_decoding
        from fusion_mlx.speculative.suffix_decoding import SuffixDecodingDrafter

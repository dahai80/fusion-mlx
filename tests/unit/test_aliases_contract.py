...
from fusion_mlx.reasoning import list_parsers as list_reasoning_parsers
...
def test_negative_control_dflash_on_moe_is_caught() -> None:
    ...
    from fusion_mlx.model_aliases import AliasProfile
    from fusion_mlx.speculative.dflash import DFlashUnavailable, check
...
def test_negative_control_dflash_missing_drafter_is_caught() -> None:
    ...
    from fusion_mlx.model_aliases import _coerce
...
def test_curated_aliases_do_not_contradict_fixture_generation_config() -> None:
    ...
    from fusion_mlx.utils.generation_config import load_generation_config_sampling

...
from fusion_mlx.api.tool_calling import parse_tool_calls
...
class TestThinkTagStripping:
    ...
    def test_strip_think_tags_utility(self):
        ...
        from fusion_mlx.tool_parsers.abstract_tool_parser import ToolParser
...
class TestTextFormatToolCallFallback:
    ...
    def minimax_parser(self):
        from fusion_mlx.tool_parsers import MiniMaxToolParser

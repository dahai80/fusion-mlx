...
class TestDFlashEngineInit:
    ...
    def test_import_without_dflash_mlx(self):
        from fusion_mlx.engine import DFlashEngine  # noqa: F401
    ...
    async def test_start_passes_verify_config_to_target_load(self, monkeypatch):
        try:
            ...
            from fusion_mlx.engine import dflash as dflash_mod
            from fusion_mlx.engine.dflash import DFlashEngine
            from fusion_mlx.patches import dflash_lifecycle
        except ImportError:
            pytest.skip("dflash-mlx not installed")
...
class TestDFlashCompatibility:
    ...
    def test_qwen_model_is_compatible(self, tmp_path):
        try:
            from fusion_mlx.engine.dflash import is_dflash_compatible
        except ImportError:
            pytest.skip("dflash-mlx not installed")
...
class TestDFlashThinkPrefix:
    ...
    def test_detect_returns_true_when_prompt_ends_with_think(self):
        try:
            from fusion_mlx.engine.dflash import DFlashEngine  # noqa: F401
        except ImportError:
            pytest.skip("dflash-mlx not installed")

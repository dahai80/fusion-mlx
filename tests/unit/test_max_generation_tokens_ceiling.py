...
via the ``FUSION_MLX_MAX_GENERATION_TOKENS`` env var, applied at parse
...
* Env set to a positive integer ``N`` → reject at parse time when
  ...
  ``FUSION_MLX_MAX_GENERATION_TOKENS`` so operators see the actionable
...
_ENV = "FUSION_MLX_MAX_GENERATION_TOKENS"

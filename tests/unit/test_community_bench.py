...
def test_stat_single_value() -> None:
    ...
    from fusion_mlx.community_bench.runner import _stat
...
def test_synthetic_prompt_deterministic() -> None:
    ...
    model weights.
    """
    from fusion_mlx.community_bench import runner
...
def test_prompt_hash_stable() -> None:
    from fusion_mlx.community_bench.runner import _prompt_hash
...
def test_scheduler_honours_ignore_eos() -> None:
    ...
    from fusion_mlx.scheduler import _assemble_stop_tokens
...
def test_standardized_config_dict_matches_schema_consts() -> None:
    ...
    from fusion_mlx.community_bench.runner import standardized_config_dict
...
def _stub_hw_sw():
    from fusion_mlx.community_bench.hardware import Hardware, Software
...
def test_build_payload_matches_schema() -> None:
    ...
    from fusion_mlx.community_bench.submission import build_submission_payload
...
def test_slugify() -> None:
    from fusion_mlx.community_bench.submission import _slugify
...
def test_submission_filename_shape() -> None:
    ...
    from fusion_mlx.community_bench.submission import _submission_filename
...
def test_ask_consent_yes() -> None:
    from fusion_mlx.community_bench.submission import _ask_consent
...
def test_submit_interactive_user_cancels(tmp_path: Path) -> None:
    ...
    from fusion_mlx.community_bench.submission import submit_interactive
...
def test_find_upstream_remote_accepts_ssh_and_https(
    ...
    from fusion_mlx.community_bench.submission import _find_upstream_remote
...
def test_find_upstream_remote_accepts_fork_with_upstream(
    ...
    from fusion_mlx.community_bench.submission import (
...
def test_origin_is_safe_github_rejects_malicious_pushurl(tmp_path) -> None:
    ...
    round-7 BLOCKING.)"""
    from fusion_mlx.community_bench.submission import _origin_is_safe_github
...
def test_make_pr_via_gh_branches_from_upstream_and_uses_owner_head(
    ...
    from fusion_mlx.community_bench import submission as sub_mod
...
def test_submit_flow_guard_consults_original_alias(monkeypatch, capsys) -> None:
    ...
    *before* calling ``_run_submit_flow``, then stashes the user-typed
    ...
    from fusion_mlx.community_bench import hardware as hw

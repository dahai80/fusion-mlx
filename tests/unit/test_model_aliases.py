...
from fusion_mlx.model_aliases import list_aliases, resolve_model, suggest_similar
...
def test_letters_only_prefix(raw, expected):
    ...
    from fusion_mlx.model_aliases import _letters_only_prefix
...
def test_popular_aliases_curated_list_resolves():
    ...
    from fusion_mlx.model_aliases import POPULAR_ALIASES

...
def test_validate_finite_in_range_passes_through_none():
    from fusion_mlx.api.models import _validate_finite_in_range
...
def test_validate_nonnegative_int_rejects_bools():
    from fusion_mlx.api.models import _validate_nonnegative_int
...
def test_validate_logit_bias_finite_passes_through_none_and_empty():
    from fusion_mlx.api.models import _validate_logit_bias_finite

...
class TestValidateModelName:
    def test_empty_string_raises_400(self):
        ...
        from fusion_mlx.service.helpers import _validate_model_name
...
class TestGuidedArrayOfObjectsSchema:
    ...
    def test_array_of_objects_maps_to_list_dict(self):
        from fusion_mlx.api.guided import json_schema_to_pydantic
...
class TestMLLMBatchGeneratorFailsLoud:
    ...
    def _source(self):
        ...
        import fusion_mlx.mllm_batch_generator as mod
    ...
    def test_scheduler_catches_value_error_from_preprocess(self):
        ...
        import fusion_mlx.mllm_scheduler as sched_mod

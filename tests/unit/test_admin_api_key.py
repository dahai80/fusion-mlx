...
def _local_login_request():
    # E-32 (#811): login() now takes a FastAPI Request for rate-limit
    # bucketing. Direct test calls must supply one whose
    # _rate_limit_client_id can read (headers.get -> falsy, client.host).

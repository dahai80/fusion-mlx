...
from fusion_mlx.tool_parsers.llama_tool_parser import LlamaToolParser
...
class TestStreamingPostProcessorToolCalls:
    ...
    def test_finalize_cross_format_fallback_swallows_parser_exception(self):
        ...
        with patch(
            "fusion_mlx.service.postprocessor.core.parse_tool_calls",
...
class TestStreamingPostProcessorGemma4StrippedForm:
    ...
    def _make_pp_with_real_parser(self):
        from fusion_mlx.tool_parsers.gemma4_tool_parser import Gemma4ToolParser
...
class TestRequestForwardedToToolParser:
    ...
    def test_qwen3_coder_streaming_with_request_extracts_tool_call(self):
        ...
        from fusion_mlx.tool_parsers.qwen3coder_tool_parser import (

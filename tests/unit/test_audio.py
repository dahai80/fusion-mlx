...
class TestSTTEngine:
    ...
    def test_default_models(self):
        ...
        from fusion_mlx.audio.stt import DEFAULT_PARAKEET_MODEL, DEFAULT_WHISPER_MODEL
    ...
    def test_transcription_result(self):
        ...
        from fusion_mlx.audio.stt import TranscriptionResult
...
class TestTTSEngine:
    ...
    def test_available_voices(self):
        """Test voice lists."""
        from fusion_mlx.audio.tts import CHATTERBOX_VOICES, KOKORO_VOICES
    ...
    def test_audio_output(self):
        ...
        from fusion_mlx.audio.tts import AudioOutput
...
class TestAudioProcessor:
    ...
    def test_default_model(self):
        ...
        from fusion_mlx.audio.processor import DEFAULT_SAM_MODEL

        assert "sam-audio" in DEFAULT_SAM_MODEL.lower()

    def test_separation_result(self):
        """Test SeparationResult dataclass."""
        from fusion_mlx.audio.processor import SeparationResult
...
class TestAPIModels:
    ...
    def test_audio_url(self):
        """Test AudioUrl model."""
        from fusion_mlx.api.models import AudioUrl
    ...
    def test_content_part_audio(self):
        ...
        from fusion_mlx.api.models import ContentPart
    ...
    def test_transcription_request(self):
        ...
        from fusion_mlx.api.models import AudioTranscriptionRequest
    ...
    def test_transcription_response(self):
        ...
        from fusion_mlx.api.models import AudioTranscriptionResponse
...
class TestAudioIntegration:
    ...
    def test_whisper_transcription(self):
        ...
        from fusion_mlx.audio import transcribe_audio
    ...
    def test_kokoro_tts(self):
        ...
        from fusion_mlx.audio import generate_speech
    ...
    def test_sam_audio_separation(self):
        ...
        from fusion_mlx.audio import separate_voice

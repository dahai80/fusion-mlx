...
def test_apply_registers_step3p7_module():
    from fusion_mlx.patches.step3p7 import apply_step3p7_patch
...
def test_apply_is_idempotent():
    from fusion_mlx.patches.step3p7 import apply_step3p7_patch, is_applied
...
def test_pre_load_dispatch_applies_step3p7_patch(tmp_path):
    from fusion_mlx.patches import step3p7

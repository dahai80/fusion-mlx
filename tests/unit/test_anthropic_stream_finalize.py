...
@pytest.mark.xfail(
    strict=False,
    reason="Streaming tool_use stop_reason not ported (strict=False: feature gap from routes_internal refactor) yet",
)
...
@pytest.mark.xfail(
    strict=False,
    reason="Streaming finalize not ported (strict=False: feature gap from routes_internal refactor) yet",
)
...
@pytest.mark.xfail(
    strict=False,
    reason="Streaming tool input not ported (strict=False: feature gap from routes_internal refactor) yet",
)

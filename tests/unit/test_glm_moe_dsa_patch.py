...
def test_glm_adaptive_prefill_config_defaults_and_gates(monkeypatch):
    from fusion_mlx.patches.glm_moe_dsa.generate_patch import (
...
def test_glm_direct_sparse_mla_uses_fork_default_threshold(monkeypatch):
    from fusion_mlx.patches.glm_moe_dsa import glm_moe_dsa_model
...
def test_glm_native_fused_kernels_match_reference(monkeypatch):
    ...
    from fusion_mlx.patches.glm_moe_dsa.sparse_mla import fused_indexer_scores
    ...
    from fusion_mlx.patches.glm_moe_dsa.sparse_mla import topk_indices_to_block_masks

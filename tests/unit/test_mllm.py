...
class TestMLLMHelperFunctions:
    ...
    def test_is_base64_image(self):
        ...
        from fusion_mlx.models.mllm import is_base64_image
    ...
    def test_is_base64_video(self):
        ...
        from fusion_mlx.models.mllm import is_base64_video
    ...
    def test_is_url(self):
        """Test URL detection."""
        from fusion_mlx.models.mllm import is_url
...
class TestVideoFrameExtraction:
    ...
    def test_extract_video_frames_smart(self, test_video_path):
        ...
        cv2 = pytest.importorskip("cv2")
        from fusion_mlx.models.mllm import extract_video_frames_smart
    ...
    def test_save_frames_to_temp(self, test_video_path):
        ...
        cv2 = pytest.importorskip("cv2")
        from fusion_mlx.models.mllm import extract_video_frames_smart, save_frames_to_temp
...
class TestImageProcessing:
    ...
    def test_process_image_input_local_file(self, test_image_path):
        ...
        from fusion_mlx.models.mllm import process_image_input
    ...
    def test_prepare_images_raises_on_fetch_failure(self, monkeypatch):
        ...
        """
        from fusion_mlx import models
        from fusion_mlx.models.mllm import MLXMultimodalLM
...
class TestVideoProcessing:
    ...
    def test_process_video_input_local_file(self, test_video_path):
        ...
        from fusion_mlx.models.mllm import process_video_input

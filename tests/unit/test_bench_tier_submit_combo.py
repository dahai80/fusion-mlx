...
from fusion_mlx.bench.tier_runner import TierResult, run_tier
...
def test_mutual_exclusive_guard_removed():
    ...
    from fusion_mlx import cli as _cli
...
def test_tier_submit_refuses_base_url(capsys):
    ...
    from fusion_mlx.cli import _run_tier_submit_flow
...
def test_smoke_payload_is_none_when_boot_time_unknown(capsys):
    ...
    metric.
    """
    from fusion_mlx.bench.tier_runner import _run_smoke

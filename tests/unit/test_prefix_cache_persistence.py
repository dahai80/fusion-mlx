...
from fusion_mlx.memory_cache import (  # noqa: E402
...
def test_save_aborts_on_post_filter_dir_loss(tmp_path, monkeypatch):
    ...
    import fusion_mlx.memory_cache as _mc_mod
...
def test_shutdown_save_prefix_cache_runs_off_event_loop(tmp_path, monkeypatch):
    ...
    from fusion_mlx import config as _config_mod
    from fusion_mlx import server as _server_mod
    from fusion_mlx.runtime import cache as _cache_mod
...
def test_adapt_should_abort_handles_keyword_only_and_args_kwargs():
    ...
    """
    from fusion_mlx.memory_cache import _adapt_should_abort
...
def test_save_to_disk_returns_false_when_rename_phase_fails(tmp_path, monkeypatch):
    ...
    """
    import fusion_mlx.memory_cache as _mc
...
def test_fsync_dir_works_on_real_directory(tmp_path):
    ...
    """
    from fusion_mlx.memory_cache import _fsync_dir
...
def test_fsync_file_works_on_real_file(tmp_path):
    ...
    """
    from fusion_mlx.memory_cache import _fsync_file
...
def test_r10d_length_prefix_drift_is_caught(tmp_path):
    ...
    from fusion_mlx.memory_cache import _TOKENS_MAGIC
...
def test_r10d_writer_stamps_v3_format_with_save_uuid(tmp_path):
    ...
    """
    from fusion_mlx.memory_cache import _TOKENS_HEADER_FIXED_LEN, _TOKENS_MAGIC
...
def test_r12_metrics_exposes_save_drift_drops():
    ...
    import fusion_mlx.routes.metrics as metrics_mod

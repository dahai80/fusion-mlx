...
def test_build_app_returns_fastapi_app() -> None:
    ...
    from fusion_mlx.speculative.dflash.runtime import DFlashRuntime
...
def test_stream_completion_surfaces_constructor_exception(monkeypatch) -> None:
    ...
    from fusion_mlx.api.models import ChatCompletionRequest, Message
    from fusion_mlx.speculative.dflash import server as srv
...
def test_dflash_e2e_chat_completion_smoke() -> None:
    ...
    from fusion_mlx.speculative.dflash.eligibility import have_runtime
    ...
    from fusion_mlx.speculative.dflash.runtime import load_runtime
    from fusion_mlx.speculative.dflash.server import _build_app

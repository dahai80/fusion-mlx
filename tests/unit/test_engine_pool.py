...
class TestExposedProfileModelResolution:
    ...
    def _manager_with_exposed_profile(self, tmp_path):
        from fusion_mlx.model_settings import ModelSettingsManager
    ...
    def test_resolve_model_id_maps_provider_prefixed_exposed_profile_to_source(
        ...
        resolved = pool.resolve_model_id("fusion_mlx/model-b:thinking", manager)
...
class TestHasActiveRequests:
    ...
    def test_base_non_streaming_engine_active_count(self):
        ...
        from fusion_mlx.engine.base import BaseNonStreamingEngine
...
class TestResolveModelId:
    ...
    def test_provider_prefix_alias_match(self, small_mock_model_dir):
        """Test alias resolution with provider prefix (e.g. fusion_mlx/alias)."""
        pool = _make_pool(ceiling=10 * 1024**3)
        pool.discover_models(str(small_mock_model_dir))
        ...
        result = pool.resolve_model_id("fusion_mlx/gpt-4", settings_manager)
        assert result == "model-a"
    ...
    def test_provider_prefix_no_match(self, small_mock_model_dir):
        ...
        result = pool.resolve_model_id("fusion_mlx/nonexistent", settings_manager)
        assert result == "fusion_mlx/nonexistent"
    ...
    def test_case_insensitive_with_provider_prefix(self, small_mock_model_dir):
        ...
        result = pool.resolve_model_id("fusion_mlx/MODEL-B", settings_manager=None)

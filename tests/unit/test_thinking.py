...
from fusion_mlx.api.thinking import ThinkingParser, extract_thinking
...
class TestExtractThinking:
    ...
    @pytest.mark.skip(reason="MiniMax M3 tags not supported in fusion-mlx")
...
class TestCleanSpecialTokens:
    ...
    @pytest.mark.skip(reason="MiniMax M3 special tokens not supported in fusion-mlx")

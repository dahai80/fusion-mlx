...
async def test_vision_with_icon():
    ...
    async with httpx.AsyncClient(timeout=TIMEOUT) as client:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if not selected_model:
                    print("❌ None of the test models are available")
        ...
        print("   Prompt: What do you see in this image? Describe it in detail.")
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                found_keywords = [
                    kw for kw in keywords if kw.lower() in message.lower()
                ]
                ...
                if found_keywords:
                    ...
                    print("   No obvious keywords detected")

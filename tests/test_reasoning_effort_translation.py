...
# Migrated from Rapid-MLX test_reasoning_effort_translation.py
# vllm_mlx.service.helpers / api.models -> fusion_mlx (helpers not migrated yet)
...
try:
    ...
    _HAS_REASONING_HELPERS = True
except ImportError:
    _HAS_REASONING_HELPERS = False
